...
- [x] 上传代码并发布 v0.2.0；网页版 https://loadplan-fleix.vercel.app ，Release https://github.com/fleixweb/Loadplan/releases/tag/v0.2.0 。Vercel GitHub 自动关联被服务端拒绝，目前采用 CLI 部署，用户可在项目 Git 设置授权连接。
